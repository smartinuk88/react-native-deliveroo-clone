  ...
  return (
    <View className="bg-[#00CCBB] flex-1">
      <SafeAreaView className="z-50">
        ...
        <View className="bg-white my-2 mx-5 p-6 rounded-md z-50 shadow-md">
      ...
      <SafeAreaView className="bg-white flex-row items-center space-x-5 h-20">
        <Image
          ...
          className="h-12 w-12 bg-gray-300 rounded-full  ml-2"
        />
        <View className="flex-1">
          <Text className="text-lg">Scott Martin</Text>
